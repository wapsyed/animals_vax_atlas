...
write.csv(btm_annotation_table_long, file = here("VaxGO", "btm_annotation_table_long.csv"))
...
#Salvar
write.csv(btm_annotation_nested, file = here("tables", "btm_annotation_genes.csv"))
...
#salvar
write.csv(btm_annotation_unique, file = here("tables","btm_annotation_unique.csv")
