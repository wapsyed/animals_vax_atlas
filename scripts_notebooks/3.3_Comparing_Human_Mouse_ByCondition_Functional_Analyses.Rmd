...
legs_perc %>%
  ...
  summarise(
            ...
            # mean_perc_mouse = mean(percent_mouse),
            median_perc_mouse = median(percent_mouse))
...
df_legs <- dge_btm_process_genes_wide %>%
  ...
  full_join(
    gsea_btm_results_core_joined,
    # filter(process == process_selected)
    by = join_by(pathogen, group, process, timepoint_comparison, symbol == gene)
  ) %>%
