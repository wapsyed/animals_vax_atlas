...
dge_btm_process_genes_diff_bygene_clean = dge_btm_process_genes_diff_bygene %>% 
  ...
  select(treatment = treatment_human, pathogen = pathogen_human, timepoint_comparison, hgnc_symbol = human_symbol, mean_log2fc_human, mean_log2fc_mouse, mean_log2fc_diff, se_mouse, p_adj_mouse) %>% 
